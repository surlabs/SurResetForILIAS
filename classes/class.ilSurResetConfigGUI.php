...
use SurReset\classes\objects\ScheduleExecutionResult;
use SurReset\classes\ui\Component\CustomFactory;
use SurReset\classes\ui\SurResetHistory;
use SurReset\classes\ui\SurResetList;
...
class ilSurResetConfigGUI extends ilPluginConfigGUI
{
    ...
    protected function setSubTabs(string $active): void
    {
        ...
        $this->ctrl->setParameterByClass('ilSurResetConfigGUI', 'schedule_id', $_GET["schedule_id"] ?? 0);
    ...
    public function configure(): void
    {
        ...
        $table = new SurResetList($this, "configure");
    ...
    public function history(): void
    {
        ...
        $table = new SurResetHistory($this, "history");
